                    ...
                    {debts.map((debt) => {
                        ...
                        return (
                            <tr key={debt.plaid_account_id || debt.name} className="hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                                <td className="px-6 py-4 text-sm font-medium text-gray-900 dark:text-slate-100 max-w-[160px]">
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600 dark:text-red-400 font-bold">${debt.remaining_balance.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-slate-400">${debt.monthly_payment.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                                <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500 dark:text-slate-400 font-bold">{(debt.interest_rate * 100).toFixed(2)}%</td>
                ...
                {debts.length > 0 && (
                    <tfoot className="bg-gray-50 dark:bg-slate-700/50 border-t-2 border-gray-100 dark:border-slate-600">
                        <tr className="font-black text-gray-900 dark:text-slate-100">
                            <td className="px-6 py-4 text-right text-[10px] font-black uppercase tracking-widest text-gray-400 dark:text-slate-500">Total Liabilities</td>
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-400 dark:text-slate-500 font-normal">
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600 dark:text-red-400 font-black">
