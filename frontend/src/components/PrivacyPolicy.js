        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-12">
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-4 leading-relaxed">
                    Financial HQ ("FHQ", "we", "our", or "us") is operated by Yury Shirokov as a solo project. This Privacy Policy describes what data we collect, why we collect it, how it is stored and protected, and your rights regarding that data. By using Financial HQ, you agree to the practices described in this policy.
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <Section icon={<Eye size={22} />} title="How We Use Your Data">
                    <p>We use your data exclusively to provide the Financial HQ service to you:</p>
                ...
                <Section icon={<Shield size={22} />} title="Third-Party Services">
                    <p>Financial HQ uses the following third-party services, each subject to their own privacy policies:</p>
                    <ul className="list-disc list-inside space-y-1 mt-2">
            ...
            <p className="text-xs text-gray-400 text-center pt-4">
                This policy may be updated periodically. Continued use of Financial HQ after changes constitutes acceptance of the revised policy.
            </p>
        </div>
    );
};
