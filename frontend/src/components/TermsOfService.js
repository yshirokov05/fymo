        ...
        <div className="space-y-6 max-w-4xl mx-auto pb-12">
            <div>
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-4 leading-relaxed">
                    These Terms of Service ("Terms") govern your use of Wealthstack, operated by Yury Shirokov. By creating an account or using the service, you agree to be bound by these Terms. If you do not agree, do not use the service.
                </p>
            </div>
            ...
            <div className="space-y-4">
                <Section icon={<FileText size={22} />} title="1. The Service">
                    <p>Wealthstack is a personal finance management tool that allows users to track net worth, budgets, income, debts, investments, and taxes in one place. Features include optional bank account syncing via Plaid, AI-generated financial summaries, and tax estimation tools.</p>
                ...
                <Section icon={<FileText size={22} />} title="2. Eligibility & Account">
                    <p>You must be at least 18 years old and a resident of the United States to use Wealthstack. By using the service, you represent that you meet these requirements.</p>
                ...
                <Section icon={<CreditCard size={22} />} title="3. Subscription & Billing">
                    <p>Wealthstack offers a free tier and a Premium subscription at <strong className="text-gray-800 dark:text-gray-100">$9.99/month</strong>, billed via Stripe.</p>
                    ...
                    <p className="mt-2">All payment processing is handled by Stripe. Wealthstack does not store your credit card information.</p>
                </Section>

                <Section icon={<AlertTriangle size={22} />} title="4. No Financial, Tax, or Legal Advice">
                    <p>Wealthstack is an informational tool, not a licensed financial institution, registered investment adviser, tax preparer, or law firm.</p>
                    <ul className="list-disc list-inside space-y-1 mt-2">
                ...
                <Section icon={<FileText size={22} />} title="5. Bank Connectivity (Plaid)">
                    ...
                    <p>Wealthstack receives read-only access to your account balances and transactions. We cannot initiate transfers or move money.</p>
                ...
                <Section icon={<Scale size={22} />} title="6. Limitation of Liability">
                    <p>To the maximum extent permitted by applicable law, Wealthstack and its operator (Yury Shirokov) shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including but not limited to:</p>
                    <ul className="list-disc list-inside space-y-1 mt-2">
                ...
                <Section icon={<FileText size={22} />} title="8. Intellectual Property">
                    <p>Wealthstack, including its code, design, branding, and content, is the intellectual property of Yury Shirokov. You may not copy, reproduce, distribute, or create derivative works without explicit written permission.</p>
            ...
            <p className="text-xs text-gray-400 text-center pt-4">
                These Terms may be updated periodically. Continued use of Wealthstack after changes constitutes acceptance of the revised Terms.
            </p>
        </div>
    );
};
